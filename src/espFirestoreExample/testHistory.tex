...
\subsection*{Test 7: Keypad Debouncing (April 16, 2025)}
Goal: Ensure the keypad registers only one press per button press.
Method: Pressed buttons rapidly to see if multiple inputs were recorded for a single press.
Result: Debouncing was successful; no duplicate inputs were recorded.
Problems: None.
\end{document}
