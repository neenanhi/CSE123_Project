...
\begin{figure}[h]
     ...
     \begin{subfigure}{0.3\textwidth}
         \centering
         \includegraphics[width=\linewidth]{../submission3/img/unlockedPage.png}
         \caption{}
         \label{fig:1a}
     \end{subfigure}
     \begin{subfigure}{0.6\textwidth}
         \centering
         \includegraphics[width=\linewidth]{../submission3/img/lockState.png}
         \caption{}
         \label{fig:1b}
     \end{subfigure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.4 \linewidth]{../submission3/img/pinPage.png}
    \caption{Pin Tab}
    \label{fig:pin}
\end{figure}
