...
\begin{center}
\begin{tabular}{ | m{6.5em} | m{10cm} |} 
  \hline
  PASS or FAIL & Conditions For Passing or Failing \\ 
  \hline
  PASS & The bolt retracts within half a second, LOCK\_STATE is 1, and logs are clean \\ 
  \hline
  FAIL & Otherwise \\ 
  \hline
\end{tabular}
...
\begin{tabular}{ | m{6.5em} | m{10cm} |} 
  ...
  PASS or FAIL & Conditions For Passing or Failing \\ 
  \hline
  PASS & The system successfully locks out further PIN attempts and indicates this state clearly. Notifies owner on mobile device of failed attempt. \\ 
  \hline
  FAIL &  Doesn't satisfy conditions above.\\ 
  \hline
\end{tabular}
\end{center}
...
\begin{tabular}{ | m{6.5em} | m{10cm} |} 
  ...
  PASS or FAIL & Conditions For Passing or Failing \\ 
  \hline
  PASS & Door should unlock immediately, and notify user about the use of an emergency pin. Logs use of the pin in cloud database.\\ 
  \hline
  FAIL &  Doesn't satisfy conditions above.\\ 
  \hline
\end{tabular}
